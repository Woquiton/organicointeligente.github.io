...
(function () {
  ...
  var _t = {
    ...
    'pt': {
      ...
      'seapo.nav_submissao_badge': 'Até 20/07',
      ...
      'seapo.dest4_desc':        'Expositores e produtos a confirmar — fique ligado nas novidades!',
      ...
      /* Stands */
      'seapo.stands_titulo':     '🌿 Stands e Exposições — Em frente ao auditório',
      'seapo.stand1':            'PANCs',
      ...
      'seapo.stand6':            'Biodiversidade',
      'seapo.stand7':            'Plantas repelentes e controle de insetos',
      'seapo.stand8':            'Biofertilizantes',
      'seapo.stand9':            'Veganismo',
      'seapo.stand10':           'Tecnologias sustentáveis',
      ...
      'seapo.mc2_titulo':        'Fabricação e Uso de Biofertilizantes',
      'seapo.mc3_titulo':        'Fabricação e Uso de Extratos Vegetais na Adubação de Plantas',
      'seapo.mc4_titulo':        'Campanha Nacional dos Orgânicos',
      'seapo.mc4_speaker2':      'Pedro Teles — Ministério da Agricultura',
      ...
      'seapo.mc8_speaker':       'Elis Regina — Química e Agricultora Orgânica',
      ...
      'seapo.prazo_data':        '20 de julho de 2026',
      'seapo.prazo_note':        'Baixe o template da sua modalidade, siga o tutorial e envie dentro do prazo.',
    ...
    'en': {
      ...
      'seapo.nav_submissao_badge': 'Until Jul 20',
      ...
      'seapo.dest4_desc':        'Exhibitors and products to be confirmed — stay tuned!',
      ...
      /* Stands */
      'seapo.stands_titulo':     '🌿 Stands and Exhibitions — In front of the auditorium',
      ...
      'seapo.stand5':            'Microgreens',
      'seapo.stand6':            'Biodiversity',
      'seapo.stand7':            'Repellent plants and insect control',
      'seapo.stand8':            'Biofertilizers',
      'seapo.stand9':            'Veganism',
      'seapo.stand10':           'Sustainable technologies',
      ...
      'seapo.mc2_titulo':        'Production and Use of Biofertilizers',
      'seapo.mc3_titulo':        'Production and Use of Plant Extracts in Crop Fertilization',
      'seapo.mc4_titulo':        'National Organic Campaign',
      'seapo.mc4_speaker2':      'Pedro Teles — Ministry of Agriculture',
      ...
      'seapo.mc8_speaker':       'Elis Regina — Chemist and Organic Farmer',
      ...
      'seapo.prazo_data':        'July 20, 2026',
      'seapo.prazo_note':        'Download your format\'s template, follow the tutorial, and submit before the deadline.',
